Lesson Link:
https://cybertalents.com/learn/introduction-to-cybersecurity/lessons/28-hash-cracking
...
Solution
In this challenge, we are given a hash. and we need to crack it to get the password of the CEO. We can use this website to identify the hash type. After uploading the hash, we will get the following result:

Hash: 06f8aa28b9237866e3e289f18ade19e1736d809d
Hash type: SHA-1
We can use this website to crack the hash. After uploading the hash, we will get the following result:
